...
if __name__ == '__main__':
    ...
    parser.add_argument('--train-file', default="datasets/91-image_x3.h5", type=str, required=True,)  # 训练 h5文件目录
    parser.add_argument('--eval-file', default="datasets/Set5_x3.h5", type=str, required=True)  # 测试 h5文件目录
    parser.add_argument('--outputs-dir', default="output", type=str, required=True)   #模型 .pth保存目录
